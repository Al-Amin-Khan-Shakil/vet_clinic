...
**vet_clinic** is a database created on PostgreSQL to store data about animal clinic.
...
<details>
  ...
  <ul>
    <li><a href="https://www.tutorialspoint.com/sql/">SQL</a></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone https://github.com/Al-Amin-Khan-Shakil/vet_clinic
```
--->
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/vet_clinic/issues).
